...
namespace IdentityDiscussion.Data.Migrations
{
    ...
    [Migration("20230424150332_dbadded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityDiscussion.Models.Member", b =>
                {
            ...
            modelBuilder.Entity("IdentityDiscussion.Models.Message", b =>
                {
            ...
            modelBuilder.Entity("IdentityDiscussion.Models.Topic", b =>
                {
                    b.Property<int>("TopicId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IdentityDiscussion.Models.Member", b =>
                {
                    b.HasOne("IdentityDiscussion.Models.Topic", "Topic")
                        .WithMany()
            ...
            modelBuilder.Entity("IdentityDiscussion.Models.Message", b =>
                {
                    b.HasOne("IdentityDiscussion.Models.Member", "Member")
                        .WithMany()
                        .HasForeignKey("MemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
